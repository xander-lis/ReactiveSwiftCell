...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ErrorDispatcher/ErrorDispatcher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ReactiveSwift/ReactiveSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ReactiveSwiftCell/ReactiveSwiftCell.framework"
